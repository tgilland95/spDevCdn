...
/***/ (function(module, exports, __webpack_require__) {
	            ...
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    ...
	                    case 34:
	                        ...
	                        (0, _jquery2.default)("#dept-retention").html('</br><div class="alert alert-info" role="alert">You are not a part of any department</div>');
	                        (0, _jquery2.default)("#common-records").html('</br><div class="alert alert-info" role="alert">You are not a part of any department</div>');
	                        (0, _jquery2.default)("#unique-records").html('</br><div class="alert alert-info" role="alert">You are not a part of any department</div>');
	...
	*/
	var loadRetentionSchedule = function () {
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dept) {
	                ...
	                switch (_context2.prev = _context2.next) {
	                    ...
	                    case 11:
	                        ...
	                        if (completeness[element]["DRS_x0020_Completed"] == "Yes") {
	                            (0, _jquery2.default)("#DRS-complete-chkbx").prop("checked", true);
	                        }
	                        if (completeness[element]["Annual_x0020_Review_x0020_Comple"] == "Yes") {
	                            (0, _jquery2.default)("#review-complete-chkbx").prop("checked", true);
	                        }
	
	                        // allows user to check/uncheck boxes
	                        (0, _jquery2.default)("#DRS-complete-chkbx").attr("disabled", "false");
	                        (0, _jquery2.default)("#review-complete-chkbx").attr("disabled", "false");
	                        (0, _jquery2.default)("#review-complete-chkbx").attr("disabled", "false");
	
	                        // adds on-click event to set DRS Complete in Completeness list
	                        (0, _jquery2.default)("#DRS-complete-chkbx").click(function () {
	                            var drsComplete;
	                        ...
	                        (0, _jquery2.default)("#review-complete-chkbx").click(function () {
	                            var reviewComplete;
	                            if ((0, _jquery2.default)(this).is(":checked")) {
	                                reviewComplete = "Yes";
	                            } else {
	                        ...
	                        (0, _jquery2.default)("#dept-ret-table").empty();
	                        (0, _jquery2.default)("#ret-table-alert").html('</br><div class="alert alert-info" role="alert">No records have been identified for this department. Please select the "Add Common Records" tab first to select records found in your department. Then add unique your department by selecting the "Add Unique Records" tab.</div>');
	                        return _context2.abrupt("return");
	
	                    case 23:
	
	                        // department has at least one record
	                        (0, _jquery2.default)("#ret-table-alert").empty();
	                    ...
	                    case 73:
	                        ...
	                        (0, _jquery2.default)("#dept-ret-table").html("</br>");
	                  ...
	                  <th style="display:none">Vital</th><th style="display:none">Highly Confidential</th><th style="display:none">Repository</th></tr> \
	                        ...
	                        (0, _jquery2.default)("#dept-ret-table").append(tableStr);
	                        (0, _jquery2.default)("#dept-ret-table").append("</br></br>");
	                        (0, _jquery2.default)("#dept-ret-buttons").empty();
	                        (0, _jquery2.default)("#dept-ret-buttons").append('<button type="button" class="btn-sm btn-primary pdf">Download</button>');
	
	                        // adds on-click event to Download button which creates PDF
	                        (0, _jquery2.default)(".pdf").click(function () {
	                            makePDF();
	                        });
	
	                        // adds on-change event to #r-cat value in 'Edit Details' dialog box
	
	                        (0, _jquery2.default)("#r-cat").on("change", function () {
	                            // extracts Record Category ID from #r-cat to find associated record in General
	                            // Retention Schedule
	
	                            (0, _jquery2.default)("#saveRecord").prop("disabled", false);
	                            var newCatID = (0, _jquery2.default)(this).val().toString().split(" ")[0];
	                            ...
	                            // empty string
	                            if ((0, _jquery2.default)("#r-cat").val() == "" || (0, _jquery2.default)("#r-cat").val() == null) {
	                                (0, _jquery2.default)("#r-func").val("");
	                                (0, _jquery2.default)("#r-ret").val(""); // else, get the associated Function and Retention and add them to the
	                                // associated textboxes
	                            } else {
	                                (0, _jquery2.default)("#r-func").val(tempRecord["Function"]);
	                                (0, _jquery2.default)("#r-ret").val(tempRecord["Retention_x0020_Description"]);
	                            }
	                        });
	
	                        // adds on-click function to 'Edit Details', populates it with associated table
	                        // data, and adds buttons to Save or Cancel
	                        (0, _jquery2.default)(".editDetails").click(function () {
	                            (0, _jquery2.default)("#saveRecord").prop("disabled", true);
	
	                            // changes color and text of button if there is a message from the Admin
	                            var initialState = {};
	                            initialState = getCurrentState();
	                            if ((0, _jquery2.default)(this).attr("class") == "btn-xs btn-success editDetails") {
	                                (0, _jquery2.default)(this).removeClass("btn-success");
	                                (0, _jquery2.default)(this).addClass("btn-primary");
	                                (0, _jquery2.default)(this)[0].innerText = "Edit";
	                            }
	                            ...
	                            (0, _jquery2.default)("#editForm").change(function (e) {
	                            ...
	                            row = (0, _jquery2.default)(this).closest("tr");
	
	                            // empties out textboxes/drop-downs and disables drop-downs just in case the
	                            // record is common
	                            (0, _jquery2.default)("#r-cat").empty();
	                            (0, _jquery2.default)("#r-repo").empty();
	                            (0, _jquery2.default)("#r-func").empty();
	                            (0, _jquery2.default)("#r-code").empty();
	                            (0, _jquery2.default)("#r-type").empty();
	                            (0, _jquery2.default)("#r-ret").empty();
	                            (0, _jquery2.default)("#r-cat").prop("disabled", "disabled");
	                            (0, _jquery2.default)("#archival").prop("checked", false);
	                            (0, _jquery2.default)("#vital").prop("checked", false);
	                            (0, _jquery2.default)("#confidential").prop("checked", false);
	                            ...
	                            var temp_id = (0, _jquery2.default)(this).closest("tr").children()[3].innerText;
	                            var temp_func = (0, _jquery2.default)(this).closest("tr").children()[1].innerText;
	                            var temp_repo = (0, _jquery2.default)(this).closest("tr").children()[14].innerText;
	
	                            // loads values in dialog (if present in table)
	                            (0, _jquery2.default)("#r-code").val((0, _jquery2.default)(this).closest("tr").children()[0].innerText);
	                            (0, _jquery2.default)("#r-type").val((0, _jquery2.default)(this).closest("tr").children()[2].innerText);
	                            (0, _jquery2.default)("#r-ret").val((0, _jquery2.default)(this).closest("tr").children().innerText);
	                            ...
	                            (0, _jquery2.default)("#r-func").empty();
	                            (0, _jquery2.default)("#r-func").append(funcOptions);
	                            ...
	                            (0, _jquery2.default)("#r-repo").empty();
	                            (0, _jquery2.default)("#r-repo").append(repoOptions);
	
	                            // checks table for archival, vital, and highly confidential - checks
	                            // corresponding boxes accordingly
	                            var archival = (0, _jquery2.default)(this).closest("tr").children()[11].innerText;
	                            var vital = (0, _jquery2.default)(this).closest("tr").children()[12].innerText;
	                            var highlyConfidential = (0, _jquery2.default)(this).closest("tr").children()[13].innerText;
	                            if (archival == "Yes") {
	                                (0, _jquery2.default)("#archival").prop("checked", true);
	                            }
	                            if (vital == "Yes") {
	                                (0, _jquery2.default)("#vital").prop("checked", true);
	                            }
	                            if (highlyConfidential == "Yes") {
	                                (0, _jquery2.default)("#confidential").prop("checked", true);
	                            }
	
	                            // enables Record Category drop-down and populates it if Function has been
	                            // selected
	                            if ((0, _jquery2.default)("#r-func").val() != "Select a function" && (0, _jquery2.default)("#r-func").val() != "" && (0, _jquery2.default)("#r-func").val() != null) {
	                                (0, _jquery2.default)("#r-cat").prop("disabled", false);
	                                ...
	                                (0, _jquery2.default)("#r-cat").empty();
	                                (0, _jquery2.default)("#r-cat").append(catOptions);
	                            }
	
	                            // unsets flag used to notify user of admin message
	                            messageRead(itemIDLookup[(0, _jquery2.default)("#r-code").val()]);
	
	                            // iterates through dept retention schedule for selected record
	                            var temp_record;
	                            for (var i = 0; i < deptRecords.length; i++) {
	                                temp_record = deptRecords[i];
	                                if (temp_record["Code"] == (0, _jquery2.default)("#r-code").val()) {
	                                    break;
	                                }
	                            }
	
	                            // uses metadata from selected record to populate fields
	                            (0, _jquery2.default)("#r-exc").val(temp_record["Retention_x0020_Exception"]);
	                            (0, _jquery2.default)("#cmts-plan").val(temp_record["CommentsPlan"]);
	                            (0, _jquery2.default)("#admin-msg").val(temp_record["Message_x0020_To_x0020_Admin"]);
	                            (0, _jquery2.default)("#admin-cmts").val(temp_record["Message_x0020_From_x0020_Admin"]);
	
	                            // uses these values to check if Status needs to be set ot 'Pending'
	                            initialCat = (0, _jquery2.default)("#r-cat").val();
	                            initialUserCmts = (0, _jquery2.default)("#admin-msg").val();
	                            initialFunc = (0, _jquery2.default)("#r-func").val();
	                            initialCmtsPlan = (0, _jquery2.default)("#cmts-plan").val();
	
	                            // if common record, don't allow user to change Record Type, Category, or
	                            // Function
	                            if ((0, _jquery2.default)(this).closest("tr").children()[0].innerText.charAt(0) == "C") {
	                                (0, _jquery2.default)("#r-type").prop("disabled", true);
	                                (0, _jquery2.default)("#r-cat").prop("disabled", true);
	                                (0, _jquery2.default)("#r-func").prop("disabled", true // if unique record, allow user to change Record Type and Function
	                                );
	                            } else {
	                                (0, _jquery2.default)("#r-type").prop("disabled", false);
	                                (0, _jquery2.default)("#r-func").prop("disabled", false);
	                            }
	                        });
	
	                        // adds on-change event to function dropdown
	                        (0, _jquery2.default)("#r-func").change(function () {
	                            // empties retention and record category
	                            (0, _jquery2.default)("#r-ret").val("");
	                            (0, _jquery2.default)("#r-cat").empty();
	
	                            // if new function chosen is empty string, disable category drop-down and empty
	                            // it
	                            if ((0, _jquery2.default)("#r-func").val() == "") {
	                                (0, _jquery2.default)("#r-cat").prop("disabled", true);
	                                (0, _jquery2.default)("#r-cat").val("");
	                                return;
	                            }
	                            ...
	                            (0, _jquery2.default)("#r-cat").prop("disabled", false);
	                            var catOptions = '<option selected="selected" disabled>Select a category</option><option></option>';
	                            for (var i = 0; i < generalFunctionLookup[(0, _jquery2.default)("#r-func").val()].length; i++) {
	                                catOptions += "<option>";
	                                catOptions += generalFunctionLookup[(0, _jquery2.default)("#r-func").val()][i];
	                                catOptions += "</option>";
	                            }
	                            (0, _jquery2.default)("#r-cat").append(catOptions);
	                        });
	                        ...
	                        // adds on-click event to Save button on dialog box
	                        (0, _jquery2.default)("#saveRecord").click(function () {
	                            // retrieves all new values from dialog
	                            var itemID = itemIDLookup[(0, _jquery2.default)("#r-code").val()];
	                            var newFunc = (0, _jquery2.default)("#r-func option:selected").val();
	                            var newType = (0, _jquery2.default)("#r-type").val();
	                            var newCatID;
	                            var newCat;
	                            if ((0, _jquery2.default)("#r-cat option:selected").val() == "Select a category" || (0, _jquery2.default)("#r-cat option:selected").val() == "" || (0, _jquery2.default)("#r-cat option:selected").val() == undefined) {
	                                newCatID = "";
	                                newCat = "";
	                            } else {
	                                newCatID = (0, _jquery2.default)("#r-cat option:selected").val().toString().split(" ")[0];
	                                newCat = (0, _jquery2.default)("#r-cat option:selected").val().toString().split(" ")[0];
	                            }
	                            var newRet = (0, _jquery2.default)("#r-ret").val();
	                            var newCmtsPlan = (0, _jquery2.default)("#cmts-plan").val();
	                            var newAdminMsg = (0, _jquery2.default)("#admin-msg").val();
	                            var notifyAdmin = 1;
	                            var newRepo = (0, _jquery2.default)("#r-repo option:selected").val();
	                            var archival = "No";
	                            var vital = "No";
	                            var highlyConfidential = "No";
	                            if ((0, _jquery2.default)("#archival").is(":checked")) {
	                                archival = "Yes";
	                            }
	                            if ((0, _jquery2.default)("#vital").is(":checked")) {
	                                vital = "Yes";
	                            }
	                            if ((0, _jquery2.default)("#confidential").is(":checked")) {
	                                highlyConfidential = "Yes";
	                            }
	
	                            // checks if record is common
	                            if ((0, _jquery2.default)("#r-code").val().charAt(0) == "C") {
	                                // calls function to update common record, close modal, and end script
	                                (0, _jquery2.default)("#ret-table-alert").html('</br><div class="alert alert-info" role="alert">Processing...</div>');
	                        ...
	                        // row selected
	                        (0, _jquery2.default)(".deleteRecord").click(function () {
	                            (0, _jquery2.default)("#delete-modal").modal("show");
	                            row = (0, _jquery2.default)(this).closest("tr");
	                        });
	
	                        // adds on-click function to 'Ok' button in Delete modal
	                        (0, _jquery2.default)("#ok-delete").click(function () {
	                            // retrieves ID of the record, deletes the row, and closes the modal
	                            var id = itemIDLookup[row.children()[0].innerText];
	                            (0, _jquery2.default)("#ret-table-alert").html('</br><div class="alert alert-info" role="alert">Processing...</div>');
	                            deleteRecord(row, id);
	                            (0, _jquery2.default)("#delete-modal").modal("hide");
	                        });
	...
	*/
	...
	var updateRecord = function () {
	    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(itemID, newFunc, newType, newCatID, newCat, newRet, newCmtsPlan, newAdminMsg, flag, newRepo, archival, vital, highlyConfidential) {
	...
	var updateCommonRecord = function () {
	    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(itemID, newCmtsPlan, newAdminMsg, newRepo, archival, vital, highlyConfidential, flag) {
	...
	var messageRead = function () {
	    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(itemID) {
	...
	var setDRS = function () {
	    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(id, drsComplete) {
	...
	var setReview = function () {
	    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(id, reviewComplete) {
	...
	*/
	            ...
	            while (1) {
	                switch (_context9.prev = _context9.next) {
	                    case 0:
	                        ...
	                        (0, _jquery2.default)("#common-records").append('<div id="common-records-alert"></div>');
	                        (0, _jquery2.default)("#common-records").append('<div id="common-records-search"></div>');
	                        (0, _jquery2.default)("#common-records").append('<div id="common-table"></div>');
	                        (0, _jquery2.default)("#common-records").append('<div id="common-buttons"></div>');
	                        (0, _jquery2.default)("#common-records").append('<div id="add-common-dialog" title="Are you sure?"></div>');
	                        (0, _jquery2.default)("#common-records").append('<div id="delete-common-dialog" title="Are you sure?"></div>');
	
	                        if (depts.length > 1) {
	                            if ((0, _jquery2.default)("#retention-dropdown option:selected").text() != "Select a department") {
	                                addCommonRecordsTable(deptParam);
	                            } else {
	                                (0, _jquery2.default)("#common-records-alert").html('</br><div class="alert alert-info" role="alert">Please select a department above</div>');
	                            }
	                        } else {
	                            addCommonRecordsTable(deptParam);
	                        }
	...
	var addCommonRecordsTable = function () {
	    var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(dept, searchTerm) {
	            ...
	            while (1) {
	                switch (_context10.prev = _context10.next) {
	                    ...
	                    case 2:
	                        ...
	                        (0, _jquery2.default)("#common-table").empty();
	                        (0, _jquery2.default)("#common-table").html('</br><table class="table table-striped" id="common-table"><thead><tr><th style="display:none">Code</th><th>Select</th><th>Function</th><th>Record Type</th> \
	...
	var addCommonRecord = function () {
	    var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(dept, rowNum, tempCode, tempFunc, tempType, tempArch, flag) {
	...
	var addUniqueFields = function () {
	    var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(dept) {
	            ...
	            while (1) {
	                switch (_context12.prev = _context12.next) {
	                    ...
	                    case 5:
	                        ...
	                        (0, _jquery2.default)("#unique-fields").html('<div class="container">');
	                        options = "";
	                        ...
	                        (0, _jquery2.default)("#unique-fields").append('</br></br><form id="uniqueRecordsForm" class="form-horizontal"> \
	    ...
	    ' + "                                  " + repoOptions + ' \
	               ...
	               <div class="form-group"> \
	                        ...
	                        (0, _jquery2.default)("#rec-func").change(function () {
	                            (0, _jquery2.default)("#retention").val("");
	                            (0, _jquery2.default)("#rec-cat").empty();
	                            if ((0, _jquery2.default)("#rec-func").val() == "") {
	                                (0, _jquery2.default)("#rec-cat").val("");
	                                (0, _jquery2.default)("#rec-cat").prop("disabled", true);
	                                return;
	                            } else {
	                                var catOptions = "<option>Select a category</option><option></option>";
	                                for (var i = 0; i < generalFunctionLookup[(0, _jquery2.default)("#rec-func").val()].length; i++) {
	                                    catOptions += "<option>";
	                                    catOptions += generalFunctionLookup[(0, _jquery2.default)("#rec-func").val()][i];
	                                    catOptions += "</option>";
	                                }
	                                (0, _jquery2.default)("#rec-cat").append(catOptions);
	                                (0, _jquery2.default)("#rec-cat").prop("disabled", false);
	                            }
	                        });
	
	                        (0, _jquery2.default)("#rec-cat").change(function () {
	                            var index = (0, _jquery2.default)("#rec-cat").val().toString().indexOf("-");
	                            var category = (0, _jquery2.default)("#rec-cat").val().toString().substring((0, _jquery2.default)("#rec-cat").val().toString().indexOf("-") + 2);
	                            (0, _jquery2.default)("#retention").val(generalRetentionLookup[category]);
	                        });
	...
	var getSize = function () {
	    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(dept) {
	...
	var updateSize = function () {
	    var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(itemID, size) {
	...
	var addSize = function () {
	    var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(dept, size) {
	...
	var addUniqueRecord = function () {
	    var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(dept, code, recType, recFunc, recCat, adminMsg, commentsPlan, highlyConfidential, vital, archival, recRepo) {
	...
	var _DataAccess = __webpack_require__(330);
	...
	*/
	function populateDeptRetentionTab() {
	    ...
	    (0, _jquery2.default)("#dept-retention").html('<div id="dept-ret-dropdown"></div>');
	    (0, _jquery2.default)("#dept-retention").append('<div id="dept-ret-table"></div>');
	    (0, _jquery2.default)("#dept-retention").append('<div id="ret-table-alert"></div>');
	    (0, _jquery2.default)("#dept-retention").append('<div id="dept-ret-buttons"></div>');
	    ...
	    if (isAdmin) {
	        ...
	        (0, _jquery2.default)("#retention-dropdown").html(optionsStr);
	        ...
	        if ((0, _jquery2.default)("#retention-dropdown option:selected").text() != "Select a department") {
	            ...
	            (0, _jquery2.default)("#ret-table-alert").html('</br><div class="alert alert-info" role="alert">Please select a department above</div>');
	        }
	        ...
	        (0, _jquery2.default)("#retention-dropdown").on("change", function () {
	            var dept = (0, _jquery2.default)(this).val().toString().slice(0, 3);
	        ...
	        deptParam = depts[0];
	        (0, _jquery2.default)("#retention-dropdown").html("<option value=" + deptParam + " selected>" + deptParam + " - " + deptNameLookup[deptParam] + "</option>");
	    ...
	    // not empty
	    var rows = (0, _jquery2.default)("#dept-ret-table tr");
	    for (var i = 1; i < rows.length; i++) {
	        var tempRow = [];
	        var cells = (0, _jquery2.default)(rows[i])[0].childNodes;
	        if ((0, _jquery2.default)(cells)[2].innerText == "" || (0, _jquery2.default)(cells)[2].innerText == "null" || (0, _jquery2.default)(cells)[2].innerText == null) {
	            tempRow.push(" - ");
	        } else {
	            tempRow.push((0, _jquery2.default)(cells)[2].innerText);
	        }
	        if ((0, _jquery2.default)(cells)[5].innerText == "" || (0, _jquery2.default)(cells)[5].innerText == "null" || (0, _jquery2.default)(cells)[5].innerText == null) {
	            tempRow.push(" - ");
	        } else {
	            tempRow.push((0, _jquery2.default)(cells)[5].innerText);
	        }
	        if ((0, _jquery2.default)(cells)[6].innerText == "" || (0, _jquery2.default)(cells)[6].innerText == "null" || (0, _jquery2.default)(cells)[6].innerText == null) {
	            tempRow.push(" - ");
	        } else {
	            tempRow.push((0, _jquery2.default)(cells)[6].innerText);
	        }
	        if ((0, _jquery2.default)(cells)[11].innerText == "Yes") {
	            tempRow.push("Yes");
	        } else {
	            tempRow.push("No");
	        }
	        ...
	        var isVital = false;
	        var isConf = false;
	        if ((0, _jquery2.default)(cells)[7].innerText != "" && (0, _jquery2.default)(cells)[7].innerText != "null" && (0, _jquery2.default)(cells)[7].innerText != null) {
	            hasComment = true;
	            comments += (0, _jquery2.default)(cells)[7].innerText;
	        }
	        if ((0, _jquery2.default)(cells)[14].innerText != "" && (0, _jquery2.default)(cells)[14].innerText != "null" && (0, _jquery2.default)(cells)[14].innerText != null && (0, _jquery2.default)(cells)[14].innerText != "Select a repository") {
	            hasRepo = true;
	            if (hasComment) {
	                comments += "\n";
	            }
	            if ((0, _jquery2.default)(cells)[14].innerText != "Other (please specify in the Comments section)") {
	                comments += "Stored in: " + (0, _jquery2.default)(cells)[14].innerText;
	            }
	        }
	        if ((0, _jquery2.default)(cells)[12].innerText == "Yes") {
	            isVital = true;
	        ...
	        if ((0, _jquery2.default)(cells)[13].innerText == "Yes") {
	            isConf = true;
	...
	function addCommonSubmitButton(deptRecords, deptIDList, length, idLookup, dept) {
	    ...
	    (0, _jquery2.default)("#common-buttons").empty();
	    (0, _jquery2.default)("#common-buttons").append('<div id="submit-alert"></div></br>');
	    (0, _jquery2.default)("#common-buttons").append('<div class="btn-group"><button type="button" class="btn btn-primary" id="common-submit">Submit</button></div>');
	    // adds events to button clicks
	    (0, _jquery2.default)("#common-submit").click(function () {
	        (0, _jquery2.default)("#submit-alert").html("");
	        var addRows = [];
	        for (var i = 0; i < length; i++) {
	            if ((0, _jquery2.default)("#commonrow" + i).find("input:checkbox")[0].checked) {
	                if (deptIDList.indexOf((0, _jquery2.default)("#commonrow" + i).children()[0].innerText) == -1) {
	                    addRows.push(i);
	                }
	            }
	        }
	        ...
	        if (addRows.length > 0) {
	            ...
	            for (var i = 0; i < addRows.length; i++) {
	                ...
	                var tempCode = (0, _jquery2.default)("#commonrow" + rowNum).children()[0].innerText;
	                var tempFunc = (0, _jquery2.default)("#commonrow" + rowNum).children()[2].innerText;
	                var tempType = (0, _jquery2.default)("#commonrow" + rowNum).children()[3].innerText;
	                var tempRet = (0, _jquery2.default)("#commonrow" + rowNum).children()[4].innerText;
	                var tempArch = (0, _jquery2.default)("#commonrow" + rowNum).children()[5].innerText;
	                if (tempArch == "") {
	                    tempArch = "No";
	                }
	                (0, _jquery2.default)("#submit-alert").html('</br><div class="alert alert-info" role="alert">Processing...</div>');
	            ...
	            (0, _jquery2.default)("#submit-alert").html('<div class="alert alert-info" role="alert">There were no records selected to be added.</div>');
	        }
	    });
	}
	...
	function populateUniqueRecordsTab() {
	    ...
	    (0, _jquery2.default)("#unique-records").append('<div id="unique-records-alert"></div>');
	    (0, _jquery2.default)("#unique-records").append('<div id="unique-fields"></div>');
	    (0, _jquery2.default)("#unique-records").append('<div id="unique-alert"></div>');
	    (0, _jquery2.default)("#unique-records").append('<div id="unique-buttons"></div>');
	    // user is a part of more than one department
	    if (depts.length > 1) {
	        if ((0, _jquery2.default)("#retention-dropdown option:selected").text() != "Select a department") {
	            addUniqueFields(deptParam);
	        } else {
	            (0, _jquery2.default)("#unique-records-alert").html('</br><div class="alert alert-info" role="alert">Please select a department above</div>');
	        }
	    } else {
	        addUniqueFields(deptParam);
	    }
	...
	function addUniqueSubmit(dept, size, itemID) {
	    (0, _jquery2.default)("#unique-buttons").empty();
	    (0, _jquery2.default)("#unique-buttons").append('<div align="center"><button type="button" class="btn btn-primary" id="unique-submit">Submit</button> \
	    &ensp;<button type="button" class="btn btn-primary" id="finished" disabled>Finished</button></div>');
	    (0, _jquery2.default)("#unique-buttons").append("\n\n\n\n\n");
	    // adds event handlers to buttons
	    (0, _jquery2.default)("#unique-submit").click(function () {
	        (0, _jquery2.default)("#unique-alert").empty();
	        if ((0, _jquery2.default)("#rec-type").val() == "") {
	            (0, _jquery2.default)("#unique-alert").html('</br><div class="alert alert-warning" role="alert">Record Type cannot be left blank</div>');
	            setTimeout(function () {
	                (0, _jquery2.default)("#unique-alert").empty();
	            }, 5000);
	            return;
	        }
	        var recRepo = (0, _jquery2.default)("#rec-repo option:selected").val();
	        if (recRepo == "Select a repository") {
	            recRepo = "";
	        }
	        var recFunc = (0, _jquery2.default)("#rec-func option:selected").val();
	        if (recFunc == "Select a function") {
	            recFunc = "";
	        }
	        var recType = (0, _jquery2.default)("#rec-type").val();
	        var recCat;
	        if ((0, _jquery2.default)("#rec-cat option:selected").val() == "" || (0, _jquery2.default)("#rec-cat option:selected").val() == null) {
	            recCat = "";
	        } else {
	            recCat = (0, _jquery2.default)("#rec-cat option:selected").val().toString().split(" ")[0];
	        }
	        var adminMsg = (0, _jquery2.default)("#adminMsg").val();
	        var commentsPlan = (0, _jquery2.default)("#commentsPlan").val();
	        (0, _jquery2.default)("#finished").prop("disabled", false);
	        var archival = "No";
	        var vital = "No";
	        var highlyConfidential = "No";
	        if ((0, _jquery2.default)("#archival-chkbx").is(":checked")) {
	            archival = "Yes";
	        }
	        if ((0, _jquery2.default)("#vital-chkbx").is(":checked")) {
	            vital = "Yes";
	        }
	        if ((0, _jquery2.default)("#confidential-chkbx").is(":checked")) {
	            highlyConfidential = "Yes";
	        }
	
	        var code = "U" + size;
	        (0, _jquery2.default)("#unique-alert").html('</br><div class="alert alert-info" role="alert">Processing...</div>');
	    ...
	    (0, _jquery2.default)("#finished").click(function () {
	        location.reload();
	    });
	}
...
/***/ (function(module, exports) {
	...
	function getGeneralRetention() {
	  return $.ajax({
	    url: "../_api/SP.AppContextSite(@target)/web/lists/getbytitle('General Retention Schedule')/items?@target='" + hostWebUrl + "'&$select=*&$orderby=Function,Record_x0020_Category_x0020_ID&$top=1000",
	    method: 'GET',
	    headers: {
	      Accept: 'application/json; odata=verbose'
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRecordsByDept = exports.getRecordsByDept = function () {
	   var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(dept) {
	...
	var updateRecord = exports.updateRecord = function () {
	   var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(itemID, newFunc, newType, newCatID, newCat, newRet, newCmtsPlan, newAdminMsg, flag, newRepo, archival, vital, highlyConfidential) {
	      return regeneratorRuntime.wrap(function _callee9$(_context9) {
	         while (1) {
	            switch (_context9.prev = _context9.next) {
	               case 0:
	...
	var updateCommonRecord = exports.updateCommonRecord = function () {
	   var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(itemID, newCmtsPlan, newAdminMsg, newRepo, archival, vital, highlyConfidential, flag) {
	      return regeneratorRuntime.wrap(function _callee10$(_context10) {
	         while (1) {
	            switch (_context10.prev = _context10.next) {
	               case 0:
	...
	var deleteRecord = exports.deleteRecord = function () {
	   var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(row, id) {
	      return regeneratorRuntime.wrap(function _callee11$(_context11) {
	         while (1) {
	            switch (_context11.prev = _context11.next) {
	               case 0:
	...
	var setDRS = exports.setDRS = function () {
	   var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(id, drsComplete) {
	      return regeneratorRuntime.wrap(function _callee13$(_context13) {
	         while (1) {
	            switch (_context13.prev = _context13.next) {
	               case 0:
	...
	var setReview = exports.setReview = function () {
	   var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(id, reviewComplete) {
	      return regeneratorRuntime.wrap(function _callee14$(_context14) {
	         while (1) {
	            switch (_context14.prev = _context14.next) {
	               case 0:
	...
	var addCommonRecord = exports.addCommonRecord = function () {
	   var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(dept, rowNum, tempCode, tempFunc, tempType, tempArch, flag) {
	      return regeneratorRuntime.wrap(function _callee15$(_context15) {
	         while (1) {
	            switch (_context15.prev = _context15.next) {
	               case 0:
	...
	var getSize = exports.getSize = function () {
	   var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(dept) {
	...
	var updateSize = exports.updateSize = function () {
	   var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(itemID, size) {
	...
	var addSize = exports.addSize = function () {
	   var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(dept, size) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=drsmain.bundle.js.map