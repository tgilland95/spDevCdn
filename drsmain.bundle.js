	            ...
	            while (1) {
	                switch (_context2.prev = _context2.next) {
	                  ...
	                  <th style="display:none">Vital</th><th style="display:none">Highly Confidential</th><th style="display:none">Repository</th></tr> \
	                        ...
	                        $(".pdf").click(function () {
	                            _IndexUtils.IndexUtils.makePDF(deptParam, deptNameLookup);
	                        });
	                        ...
	                        $("#r-cat").on("change", function () {
	                            ...
	                            var newCatID = $(this).val().toString().split(" ")[0];
	                        ...
	                        $("#saveRecord").click(function () {
	                            ...
	                            if ($("#r-cat option:selected").val() == "Select a category" || $("#r-cat option:selected").val() == "" || $("#r-cat option:selected").val() == undefined) {
	                                ...
	                                newCatID = $("#r-cat option:selected").val().toString().split(" ")[0];
	                                newCat = $("#r-cat option:selected").val().toString().split(" ")[0];
	                            }
	    ...
	    ' + "                                  " + repoOptions + ' \
	               ...
	               <div class="form-group"> \
	                        ...
	                        $("#rec-cat").change(function () {
	                            var index = $("#rec-cat").val().toString().indexOf("-");
	                            var category = $("#rec-cat").val().toString().substring($("#rec-cat").val().toString().indexOf("-") + 2);
	...
	function populateDeptRetentionTab() {
	    ...
	    if (isAdmin) {
	        ...
	        $("#retention-dropdown").on("change", function () {
	            var dept = $(this).val().toString().slice(0, 3);
	...
	function addUniqueSubmit(dept, size, itemID) {
	    ...
	    $("#unique-submit").click(function () {
	        ...
	        if ($("#rec-cat option:selected").val() == "" || $("#rec-cat option:selected").val() == null) {
	            ...
	            recCat = $("#rec-cat option:selected").val().toString().split(" ")[0];
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IndexUtils = exports.IndexUtils = {
	    makePDF: function makePDF(deptParam, deptNameLookup) {
	    ...
	    deleteRecord: function () {
	        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(row, id) {
	            return regeneratorRuntime.wrap(function _callee$(_context) {
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        case 0:
	    ...
	    updateRecord: function () {
	        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(itemID, newFunc, newType, newCatID, newCat, newRet, newCmtsPlan, newAdminMsg, flag, newRepo, archival, vital, highlyConfidential) {
	            return regeneratorRuntime.wrap(function _callee2$(_context2) {
	                while (1) {
	                    switch (_context2.prev = _context2.next) {
	                        case 0:
	        ...
	        function updateRecord(_x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
	            return _ref2.apply(this, arguments);
	        }
	    ...
	    // updates common record based on ID and metadata passed in
	    updateCommonRecord: function () {
	        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(itemID, newCmtsPlan, newAdminMsg, newRepo, archival, vital, highlyConfidential, flag) {
	            return regeneratorRuntime.wrap(function _callee3$(_context3) {
	                while (1) {
	                    switch (_context3.prev = _context3.next) {
	                        case 0:
	        ...
	        function updateCommonRecord(_x16, _x17, _x18, _x19, _x20, _x21, _x22, _x23) {
	            return _ref3.apply(this, arguments);
	        }
	
	        return updateCommonRecord;
	    }(),
	
	
	    // unsets flag which alerts user of new message from admin
	    messageRead: function () {
	        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(itemID) {
	            return regeneratorRuntime.wrap(function _callee4$(_context4) {
	                while (1) {
	                    switch (_context4.prev = _context4.next) {
	                        case 0:
	    ...
	    // sets/unsets flag which specifies if dept completed their DRS
	    setDRS: function () {
	        var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(id, drsComplete) {
	            return regeneratorRuntime.wrap(function _callee5$(_context5) {
	                while (1) {
	                    switch (_context5.prev = _context5.next) {
	                        case 0:
	    ...
	    // sets/unsets flag which specifies if dept completed their Annual Review
	    setReview: function () {
	        var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(id, reviewComplete) {
	            return regeneratorRuntime.wrap(function _callee6$(_context6) {
	                while (1) {
	                    switch (_context6.prev = _context6.next) {
	                        case 0:
	        ...
	        function setReview(_x27, _x28) {
	            return _ref6.apply(this, arguments);
	        }
	
	        return setReview;
	    }(),
	    populateCommonRecordsTab: function () {
	        var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(depts, deptParam) {
	            return regeneratorRuntime.wrap(function _callee7$(_context7) {
	                while (1) {
	                    switch (_context7.prev = _context7.next) {
	                        case 0:
	                            ...
	                            if (depts.length > 1) {
	                                if ($("#retention-dropdown option:selected").text() != "Select a department") {
	                                    IndexUtils.addCommonRecordsTable(deptParam);
	                                } else {
	                                    $("#common-records-alert").html('</br><div class="alert alert-info" role="alert">Please select a department above</div>');
	                                }
	                            } else {
	        ...
	        function populateCommonRecordsTab(_x29, _x30) {
	            return _ref7.apply(this, arguments);
	        }
	
	        return populateCommonRecordsTab;
	    }(),
	    addCommonRecordsTable: function () {
	        var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(dept, searchTerm, commonRecordsList) {
	            var deptRecords, deptIDList, idLookup, i, tableRows, arch;
	            return regeneratorRuntime.wrap(function _callee8$(_context8) {
	                while (1) {
	                    switch (_context8.prev = _context8.next) {
	                        case 0:
	      ...
	      ' + "                              <th>Retention Description</th><th>Archival</th></t" + "r></thead><tbody>" + tableRows + "</tbody></table>");
	                            // adds buttons below
	                            IndexUtils.addCommonSubmitButton(deptRecords, deptIDList, commonRecordsList.length, idLookup, dept);
	        ...
	        function addCommonRecordsTable(_x31, _x32, _x33) {
	            return _ref8.apply(this, arguments);
	        }
	
	        return addCommonRecordsTable;
	    }(),
	    addCommonSubmitButton: function addCommonSubmitButton(deptRecords, deptIDList, length, idLookup, dept) {
	        // adds buttons to Common Records tab below table
	        $("#common-buttons").empty();
	        $("#common-buttons").append('<div id="submit-alert"></div></br>');
	        $("#common-buttons").append('<div class="btn-group"><button type="button" class="btn btn-primary" id="common-submit">Submit</button></div>');
	    ...
	    addCommonRecord: function () {
	        var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(dept, rowNum, tempCode, tempFunc, tempType, tempArch, flag) {
	            return regeneratorRuntime.wrap(function _callee9$(_context9) {
	                while (1) {
	                    switch (_context9.prev = _context9.next) {
	                        case 0:
	        ...
	        function addCommonRecord(_x34, _x35, _x36, _x37, _x38, _x39, _x40) {
	            return _ref9.apply(this, arguments);
	        }
	
	        return addCommonRecord;
	    }(),
	    populateUniqueRecordsTab: function populateUniqueRecordsTab() {
	        // adds divs for different parts of unique records tab
	        $("#unique-records").append('<div id="unique-records-alert"></div>');
	        $("#unique-records").append('<div id="unique-fields"></div>');
	        $("#unique-records").append('<div id="unique-alert"></div>');
	    ...
	    addUniqueFields: function () {
	        var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(dept) {
	            var result, size, itemID, options, funcList, i, repoOptions;
	            return regeneratorRuntime.wrap(function _callee10$(_context10) {
	                while (1) {
	                    switch (_context10.prev = _context10.next) {
	        ...
	        function addUniqueFields(_x41) {
	            return _ref10.apply(this, arguments);
	        }
	
	        return addUniqueFields;
	    }(),
	    addUniqueSubmit: function addUniqueSubmit(dept, size, itemID) {
	        $("#unique-buttons").empty();
	        $("#unique-buttons").append('<div align="center"><button type="button" class="btn btn-primary" id="unique-submit">Submit</button> \
	        &ensp;<button type="button" class="btn btn-primary" id="finished" disabled>Finished</button></div>');
	        $("#unique-buttons").append("\n\n\n\n\n");
	    ...
	    getSize: function () {
	        var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(dept) {
	            return regeneratorRuntime.wrap(function _callee11$(_context11) {
	                while (1) {
	                    switch (_context11.prev = _context11.next) {
	                        case 0:
	    ...
	    updateSize: function () {
	        var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(itemID, size) {
	            return regeneratorRuntime.wrap(function _callee12$(_context12) {
	                while (1) {
	                    switch (_context12.prev = _context12.next) {
	                        case 0:
	    ...
	    addSize: function () {
	        var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(dept, size) {
	            return regeneratorRuntime.wrap(function _callee13$(_context13) {
	                while (1) {
	                    switch (_context13.prev = _context13.next) {
	                        case 0:
	        ...
	        function addSize(_x45, _x46) {
	            return _ref13.apply(this, arguments);
	        }
	
	        return addSize;
	    }(),
	    addUniqueRecord: function () {
	        var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(dept, code, recType, recFunc, recCat, adminMsg, commentsPlan, highlyConfidential, vital, archival, recRepo) {
	            return regeneratorRuntime.wrap(function _callee14$(_context14) {
	                while (1) {
	                    switch (_context14.prev = _context14.next) {
	                        case 0:
	        ...
	        function addUniqueRecord(_x47, _x48, _x49, _x50, _x51, _x52, _x53, _x54, _x55, _x56, _x57) {
	            return _ref14.apply(this, arguments);
	        }
	
	        return addUniqueRecord;
	    }(),
	    populateTabs: function populateTabs(dept, deptRecords, isAdmin) {
	        // function to populate the first tab seen by user
	        IndexUtils.populateDeptRetentionTab();
	
	        // adds on-click event when changing tabs - loads respective tab
	        $('a[data-toggle="tab"]').on("shown.bs.tab", function (e) {
	            var target = $(e.target).attr("href");
	            if (target == "#dept-retention") {
	                IndexUtils.populateDeptRetentionTab(isAdmin);
	            } else if (target == "#common-records") {
	                IndexUtils.populateCommonRecordsTab(dept, deptRecords);
	            } else if (target == "#unique-records") {
	                $("#finished").prop("disabled", "disabled");
	                IndexUtils.populateUniqueRecordsTab();
	            }
	        });
	    },
	    populateDeptRetentionTab: function populateDeptRetentionTab(isAdmin) {
	        // divs to organize content in Dept Retention tab
	        $("#dept-retention").html('<div id="dept-ret-dropdown"></div>');
	        $("#dept-retention").append('<div id="dept-ret-table"></div>');
	        $("#dept-retention").append('<div id="ret-table-alert"></div>');
	        ...
	        if (isAdmin) {
	            ...
	            // reloaded, else alerts user to select a department
	            if ($("#retention-dropdown option:selected").text() != "Select a department") {
	                IndexUtils.loadRetentionSchedule(deptParam);
	            } else {
	                $("#ret-table-alert").html('</br><div class="alert alert-info" role="alert">Please select a department above</div>');
	            }
